            ...
            <div className="content-pad">
                ...
                <div className="section">
                    <h2 className="section-title">
                        CALENDAR <span className="section-subtitle">/(Track your tasks)</span>
                    </h2>

                    <div className="calendar-scroll">
                        {calendarDays.map((day) => (
                            <Link to="/calender" key={day} className="no-link">
                                <div className={`cal-day ${day === 3 ? 'active' : ''}`}>{day}</div>
                            </Link>
                        ))}
                    </div>
                    <div className="cal-indicator-wrapper">
                        <div className="cal-indicator"></div>
                    </div>
                ...
                <div className="section mt-4">
                    <h2 className="section-title main-title">
                        RECOMMENDED<br />Tasks<br />
                        <span className="script-title">for you</span>
                    </h2>
